    ...
    extends AuthenticatedResource
{
    ...
    private static final int SECRET_KEY_SIZE_LIMIT = 256;
    ...
    private final SecretStoreProvider ssp;
            ...
            throws IOException, ResourceConflictException, ResourceNotFoundException
    {
        ...
        SecretControlStore store = ssp.getSecretStoreControl(getSiteId());
